			...
			<body>
				<header className="border-b border-border bg-surface">
					<div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-3">
						<Link
							href="/"
							className="text-sm font-semibold text-text no-underline hover:text-accent"
						>
							Citey
						</Link>
						<a
							...
							className="inline-flex items-center gap-1.5 text-sm font-medium text-text-muted no-underline hover:text-accent"
							aria-label="View Citey on GitHub (opens in new tab)"
						>
							<svg
								viewBox="0 0 16 16"
								width="16"
